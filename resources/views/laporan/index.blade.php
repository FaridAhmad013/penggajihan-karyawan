<x-app-layout>
    ...
    @if (request()->month)
    @if($salaries->count())
    <div class="bg-white shadow-lg rounded-lg overflow-hidden p-6 relative transform transition-all duration-1000">
    ...
    <x-data-not-found message="Laporan Gaji Untuk {{ \Carbon\Carbon::parse(request()->month)->isoFormat('MMMM YYYY') }} Kosong"/>
