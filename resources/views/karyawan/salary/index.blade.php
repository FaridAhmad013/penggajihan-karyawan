<x-app-layout>
    ...
    <div class="flex justify-center">
        <div class="bg-white shadow-lg p-6 lg:w-8/12 md:w-10/12 w-full">
            ...
            <table class="table leading-relaxed" id="myTable">
                <thead class="bg-gradient-to-r from-teal-500 to-sky-600 px-3 py-2 text-white print:font-semibold print:text-black">
                    <tr>
                        <th class="lg:px-4 px-2 py-2 lg:text-base text-sm print:border-b-2">Tanggal</th>
                        <th class="lg:px-4 px-2 py-2 lg:text-base text-sm print:border-b-2">Gaji Bersih</th>
                        <th class="lg:px-4 px-2 py-2 lg:text-base text-sm print:border-b-2">Gaji Kotor</th>
                        <th class="lg:px-4 px-2 py-2 lg:text-base text-sm print:hidden">Opsi</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="odd:bg-green-50">
                        ...
                        <td class="lg:px-4 px-2 lg:py-2 py-1  lg:text-base text-xs">
                           <span class="bg-green-600 bg-opacity-50 text-green-50 p-1 ">Rp. {{ number_format($gaji_bersih, 2, ',', ',') }}</span>
                        </td>
                        <td class="lg:px-4 px-2 lg:py-2 py-1  lg:text-base text-xs">
                           <span class="bg-lime-500 bg-opacity-50 text-lime-50 p-1 ">Rp. {{ number_format($gaji_kotor, 2, ',', ',') }}</span>
                        </td>
                        <td class="lg:px-4 px-2 lg:py-2 py-1 font-sans lg:text-base text-sm print:hidden">
                            <a href="{{ route('employee-salary.show', [$employee->username, $salary->id]) }}" class="text-sm p-1 bg-green-300 bg-opacity-20  text-green-400" title="Lihat Slip Gaji">Slip Gaji</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
