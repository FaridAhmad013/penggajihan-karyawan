<x-app-layout>
    ...
    <div class="relative -mt-14">
        <div class="flex flex-wrap">
            ...
            <div class="lg:w-4/12 md:w-4/12 sm:w-6/12 w-full transition-all  duration-1000 ease-in">
                <x-card-header class="bg-gradient-to-br from-yellow-500 to-amber-400 text-stone-50" :link="route('salary.active')" :title="'Karyawan Yang Sudah Digaji'" :value="$salaries->count()">
